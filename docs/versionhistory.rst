...
- Fixed the encoder not giving a nested stringref namespace (tag 256) its own index space. The
  outer namespace was neither set aside on entry nor restored on exit, so string references emitted
